function all() {
    ...
    $.ajax({
        url: 'http://localhost:8080/v1/ProyectoFinalJDH/Transporte',
        method: 'GET',
...
function findById(id) {
    $.ajax({
        url: 'http://localhost:8080/v1/ProyectoFinalJDH/Transporte/' + id,
        method: 'GET',
        success: function (data) {
            $("#id").val(data.id);
            $("#tipo").val(data.tipo);
...
function update() {
    ...
    // Enviar datos al servidor mediante AJAX
    $.ajax({
        url: 'http://localhost:8080/v1/ProyectoFinalJDH/Transporte/' + $("#id").val(),
...
function deleteLogical(id) {
    ...
    // Enviar datos al servidor mediante AJAX
    $.ajax({
        url: 'http://localhost:8080/v1/ProyectoFinalJDH/Transporte/deleteLogical/' + id,
        method: 'PUT',  // Cambia a 'PUT' si es una actualización
        contentType: 'application/json',
        data: JSON.stringify(jsonData),
        success: function (response) {
